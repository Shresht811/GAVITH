                        ...
                        <div key={index} className="planet-container" style={{
                            ...
                            <div className="planet-wrapper" style={{
                                ...
                                <div className="planet-shape" style={{
                                    ...
                                    borderRadius: '50%',
                                    background: index === 0 
                                        ? `radial-gradient(circle at 30% 30%, #4facfe 0%, #00f2fe 30%, #1e3c72 70%, #000 100%)` // Earth-like
                                        : index === 1 
                                            ? `radial-gradient(circle at 30% 30%, #fa709a 0%, #fee140 40%, #c12b2b 80%, #000 100%)` // Gas Giant
                                            : `radial-gradient(circle at 30% 30%, #6a11cb 0%, #2575fc 50%, #1a1a1a 90%, #000 100%)`, // Exotic
                                    boxShadow: `
                                        inset -50px -50px 100px rgba(0,0,0,0.95),
                                        inset 30px 30px 50px rgba(255,255,255,0.2),
                                        0 0 60px ${item.color}33
                                    `,
                                    display: 'flex',
                                    flexDirection: 'column',
                                    alignItems: 'center',
