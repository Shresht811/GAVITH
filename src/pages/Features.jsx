            ...
            <div className="container" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
                <ScrollReveal>
                    <div style={{ marginBottom: '8rem', borderBottom: '1px solid rgba(0, 210, 255, 0.3)', paddingBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '2rem' }}>
                        <div>
                            <h1 style={{ fontSize: 'clamp(3rem, 6vw, 6rem)', fontWeight: '800', letterSpacing: '-0.02em', lineHeight: 0.9 }}>
                                SYSTEM CORE<span style={{ color: '#00d2ff' }}> </span>
                            </h1>
                            <p style={{ fontFamily: 'monospace', color: '#00d2ff', marginTop: '1rem' }}>
                ...
                <div style={{ marginBottom: '10rem' }}>
                    <ScrollReveal>
                        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '3rem' }}>
                            <div style={{ width: '10px', height: '10px', background: '#00d2ff', marginRight: '1rem' }}></div>
                            <h2 style={{ fontSize: '2rem', letterSpacing: '0.1em' }}>GAVITH BUILD <span style={{ color: 'rgba(255,255,255,0.3)' }}> ONSITE</span></h2>
                        </div>
                    </ScrollReveal>
                ...
                <div style={{ marginBottom: '5rem' }}>
                    <ScrollReveal>
                        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '3rem' }}>
                            <div style={{ width: '10px', height: '10px', background: '#005bea', marginRight: '1rem' }}></div>
                            <h2 style={{ fontSize: '2rem', letterSpacing: '0.1em' }}>GAVITH MARKET <span style={{ color: 'rgba(255,255,255,0.3)' }}> SUPPLY</span></h2>
                        </div>
                    </ScrollReveal>
